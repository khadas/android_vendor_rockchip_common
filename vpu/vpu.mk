...
ifneq ($(filter rk3228 rk3288 rk3328 rk3366 rk3399 rk3126c rk3399pro, $(strip $(TARGET_BOARD_PLATFORM))), )
PRODUCT_PACKAGES += \
    libmpp \
    libvpu
endif
...
ifneq ($(filter rk312x rk3126c rk3128 rk3188, $(TARGET_BOARD_PLATFORM)), )
    ...
    ifneq ($(filter rk3228 rk3366 rk3399 rk3399pro, $(TARGET_BOARD_PLATFORM)), )
        PRODUCT_COPY_FILES += \
...
ifneq ($(filter rk3228 rk3229 rk322x rk3328 rk3399 rk3399pro, $(strip $(TARGET_BOARD_PLATFORM))), )
