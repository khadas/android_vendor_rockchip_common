                ...
                case MSG_UPDATE_TIME:
                    if (1 == MainActivity.ageing_flag) {
                        if (2 == ageing_test_step && 2 != led_status) {
                            Tools.writeFile(Tools.Red_Led,"heartbeat");
                            Tools.writeFile(Tools.Green_Led,"heartbeat");
                            Tools.writeFile(Tools.Blue_Led,"heartbeat");
                            led_status = 2;
                        } else {
                            if (1 == led_status) {
                                Tools.writeFile(Tools.Red_Led,"off");
                                Tools.writeFile(Tools.Green_Led,"off");
                                Tools.writeFile(Tools.Blue_Led,"off");
                                led_status = 0;
                            } else if(0 == led_status) {
                                Tools.writeFile(Tools.Red_Led,"default-on");
                                Tools.writeFile(Tools.Green_Led,"default-on");
                                Tools.writeFile(Tools.Blue_Led,"default-on");
                                led_status = 1;
                            }
                        }
                    }
